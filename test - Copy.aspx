...
<script runat="server">
    ...
    protected void page_load(object sender, EventArgs e)
    {
        ...
        {
            SqlDataSource1.InsertParameters["uname"].DefaultValue = "test";
            //timer.Enabled = true;
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" EnableCaching="True" InsertCommand="INSERT INTO appuserdetails(uname, uloggedin, winner, wintimes, paid, amount, currenttspot) VALUES ('1', '1', '1', '1', '1', '1', '1')" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT appuserdetails.* FROM appuserdetails">
            <InsertParameters>
                <asp:Parameter DefaultValue="" Name="uname" Type="String" />
            </InsertParameters>
        </asp:SqlDataSource>
    </form>
</body>
