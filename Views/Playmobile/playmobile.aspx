    ...
    protected void checkusername()
    {
        ...
        if (Hiddenfield1 != null)
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                SqlDataSource1.InsertCommand = "INSERT INTO appuserdetails(uname, uloggedin, winner, wintimes, paid, amount, currenttspot, device) VALUES ('" + Hiddenfield1 + "', 'no', 'no', '0', 'no', '0', '', 'mobile')";
