...
<!-- Facebook Conversion Code for thmobile -->
<script>(function() {
...
window._fbq.push(['track', '6013464528293', {'value':'0.01','currency':'INR'}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6013464528293&amp;cd[value]=0.01&amp;cd[currency]=INR&amp;noscript=1" /></noscript>
...
<div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;    visibility:hidden; position: absolute; background-color: #669999;" id="showprof">
        ...
        <button id="Button4" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 124px; height: 35px; background-color: #FF00FF; color: #FFFFFF; top: 225px; left: 210px;">Back to Game</button>
</div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;   visibility:hidden; position: absolute; background-color: #9900FF" id="showspot">
        ...
        <button id="pay0" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 79px; height: 26px; background-color: #FF00FF; color: #FFFFFF; top: 240px; left: 60px;">Buy Now</button>
        <button id="Button5" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 124px; height: 41px; background-color: #FF00FF; color: #FFFFFF; top: 229px; left: 230px;" onclick="hidediv();">Back to Game</button>
        </div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;    visibility:hidden; position: absolute; background-color: #666633" id="showpromo">
        ...
        <button onclick="payer_promotion();" style="z-index: 1; left: 143px; top: 192px; position: absolute; background-color: #0000CC; color: #FFFF00; width: 180px;">Concessional TreasureSpots</button>
         <button id="Button6" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 126px; height: 42px; background-color: #FF00FF; color: #FFFFFF; top: 233px; left: 179px;">Back to Game</button>
        </div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;   visibility:hidden; position: absolute; background-color: #FF6666" id="showlife">
        ...
        <button id="pay2" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 79px; height: 26px; background-color: #FF00FF; color: #FFFFFF; top: 240px; left: 70px;">Buy Now</button>
        <button id="Button7" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 115px; height: 41px; background-color: #FF00FF; color: #FFFFFF; top: 229px; left: 230px;" onclick="actionthgame();">Back to Game</button>
        </div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;  visibility:hidden; position: absolute; background-color: #FF5050" id="showtweet">
            ...
            <asp:Label ID="Label16" runat="server" style="z-index: 1; left: 30px; top: 86px; position: absolute; vertical-align: middle; text-align:center; width: 394px; margin-top: 0px; bottom: 176px;" Text="To Make TreasureHunting more interesting tweet on Twitter and Expres Yourself" ForeColor="White"></asp:Label>
              <button id="Button8" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 136px; height: 34px; background-color: #FF00FF; color: #FFFFFF; top: 245px; left: 260px;" onclick="actionrewards();">Back to Game</button>
        <a href="https://twitter.com/share" class="twitter-share-button" data-lang="en" style="text-decoration:none; position: absolute; top: 260px; left: 127px; width: 102px;">Tweet</a>    
        </div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;  visibility:hidden; position: absolute; background-color: #3333FF" id="showtools">
        ...
        <button id="pay3" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 79px; height: 26px; background-color: #FF00FF; color: #FFFFFF; top: 240px; left: 90px;">Buy Now</button>
        <button id="Button9" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 107px; height: 39px; background-color: #FF00FF; color: #FFFFFF; top: 234px; left: 226px;">Back to Game</button>
        </div>
        <div style="width: 438px; height: 300px; z-index: 1000; left: 6px; top: 156px;  visibility:hidden; position: absolute; background-color: #FF5050" id="showfriends">
            ...
            <asp:Label ID="Label21" runat="server" style="z-index: 1; left: 30px; top: 86px; position: absolute; vertical-align: middle; text-align:center; width: 394px; margin-top: 0px; bottom: 176px;" Text="To Make TreasureHunting more interesting invite your Friends and Like the Game" ForeColor="White"></asp:Label>
              <button id="Button10" style="border-radius:10px; text-align:center; vertical-align:middle; border: medium outset #FFFF00; position:absolute; width: 118px; height: 32px; background-color: #FF00FF; color: #FFFFFF; top: 247px; left: 300px;" onclick="ifriends();">Back to Game</button>
        ...
        <asp:TextBox ID="lives" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" ReadOnly="True" Style="z-index: 1; left: 202px; top: 25px; position: absolute; width: 18px; height: 18px;" ForeColor="#FFCC00" meta:resourcekey="livesResource1" ViewStateMode="Enabled" Font-Size="Small">15</asp:TextBox>
        ...
        <label style="position: absolute; top: 90px; left: 7px; height: 19px; color: #FFCC00; width: 74px; font-size: x-small;">Achievements</label>
        <div id="divplayer" style="z-index: 203; background-color: transparent; overflow: hidden; width: 362px; height: 300px; position: absolute; top: 216px; left: 5px; right: 505px; bottom: 116px; display: inline;">
    ...
    <img id="Img9" src="https://treasurehunter.apphb.com/Images/goldshower.gif" style="border: thin solid Transparent; width: 300px; height: 200px; top: 41px; left: 22px; z-index: 1; visibility: hidden; right: 34px; bottom: 54px; position: absolute;" />
        ...
        <input id="Button2" style="background-color: #6699FF; color: #FFFFFF; z-index: 1; left: 298px; top: 90px; position: absolute; font-size: x-small;" type="button" value="Send" onclick="send2server();" />
        ...
        <asp:TextBox ID="TextBox3" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" Style="z-index: 1; left: 190px; top: 62px; position: absolute; width: 44px; right: 963px; bottom: 489px;" ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false" Font-Size="X-Small">Collect</asp:TextBox>
        <asp:TextBox ID="TextBox4" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" Style="z-index: 1; left: 242px; top: 60px; position: absolute; width: 47px; height: 15px; right: 908px;" ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false" Font-Size="X-Small"></asp:TextBox>
