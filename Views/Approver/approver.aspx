...
<script runat="server">
    ...
    {
        AccessDataSource1.SelectCommand = "SELECT tsname, tsapproved, tsactive FROM tspots where tsapproved = 'no' and tsactive = 'no'";
        DataView dv = (DataView)AccessDataSource1.Select(DataSourceSelectArguments.Empty);
        DataTable dt = new DataTable();
        dt = dv.ToTable();
        if (dt.Rows.Count != 0)
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        AccessDataSource1.UpdateCommand = "UPDATE appuserdetails SET amount='" + Convert.ToString(Convert.ToInt16(amount) + Convert.ToInt16("0.25")) + "' where uname = '" + Hiddenfield1 + "'";
            AccessDataSource1.Update();
...
<body   style="height: 507px; background-color:#000000; width: 967px; overflow:hidden;" onmouseover="moveprop(event)" onmousedown="explodeprop(event)" onkeydown="check(e)" >
    ...
    <form id="form1"  runat="server" >
        ...
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 4px; top: 345px; position: absolute; width: 332px; height: 114px" TextMode="MultiLine"></asp:TextBox>
...
<asp:Button ID="Button1" runat="server" style="z-index: 1; left: 274px; top: 478px; position: absolute" Text="Approve" OnClick="Button1_Click" />
