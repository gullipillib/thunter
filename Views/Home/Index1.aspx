...
400-1000               8                       100</asp:TextBox>
        ...
        <div style="width: 49%; height: 67%; z-index: 1000; left: 38%; top: 22%; visibility: hidden; position: absolute; background-color: #669999;" id="showprof">
            ...
            <asp:HyperLink ID="Hyperlink8" runat="server" Font-Underline="False" NavigateUrl="http://astore.amazon.com/treasurehun05-20" Style="z-index: 1001; border-radius: 2%; background-color: #0000FF; top: 40%; position: absolute; height: 6%; width: 34%; left: 23%; text-align: center; vertical-align: middle;" Target="_self" ForeColor="#FFCC00" meta:resourcekey="Hyperlink1Resource1" ViewStateMode="Enabled" Font-Size="100%">Buy Professional Help</asp:HyperLink>
        ...
        <div style="width: 49%; height: 66%; z-index: 1000; left: 38%; top: 24%; visibility: hidden; position: absolute; background-color: #9900FF" id="showspot">
            ...
            <asp:HyperLink ID="Hyperlink13" runat="server" Font-Underline="False" NavigateUrl="https://treasurehunter.apphb.com/mid.html" Style="z-index: 1; left: 18%; top: 68%; position: absolute; border-radius: 2%; background-color: #FF9900; width: 36%; height: 14%; cursor: pointer; text-decoration: none;" Target="_blank" ForeColor="White" BackColor="#FF9900" ImageUrl="https://www.paypalobjects.com/en_GB/i/btn/btn_buynowCC_LG.gif"></asp:HyperLink>
        ...
        <asp:Button ID="Button3" runat="server" BackColor="Transparent" BorderColor="#CCCCFF" BorderStyle="Solid" Font-Size="60%" ForeColor="White" 
			Style="z-index: 1; left: 89%; top: 66%; cursor: pointer; position: absolute; width: 10%; height: 5%;" Text="Rate Good to this TreasureSpot" OnClick="Button3_Click" CausesValidation="False" 
        ...
        <label style="position: absolute; top: 64%; left: 25%; height: 3%; color: #FFFFFF; font-family: Script; font-size: 70%; width: 8%;">Talk to other Players</label>
        ...
        <asp:TextBox ID="TextBox1" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" 
			Style="z-index: 1; left: 62%; top: 14%; position: absolute; width: 11%; height:4%; text-align:center; vertical-align:middle;" ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false" 
        ...
        <asp:TextBox ID="TextBox2" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" 
			Style="z-index: 1; left: 74%; top: 14%; position: absolute; width: 7%; height:4%; text-align:center; vertical-align:middle;" ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false">120</asp:TextBox>
