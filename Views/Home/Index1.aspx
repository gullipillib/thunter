...
<<<<<<< HEAD
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="14pt" ForeColor="#9999FF" Style="z-index: 1; left: 212px; top: 0px; position: absolute; width: 328px; height: 26px" Text="Label" meta:resourcekey="Label1Resource1"></asp:Label>
        ...
        <asp:hyperlink ID="Hyperlink5" runat="server"  Font-Underline="False" NavigateUrl="~/Play/play" style="z-index: 1; border-radius:15px; background-color: #FF9900;  left: 778px; top: 52px; position: absolute; height: 23px; width: 57px;" Target="_self" ForeColor="White">Winners</asp:hyperlink>


        <asp:TextBox ID="ehits" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" ReadOnly="True" Style="z-index: 1; left: 116px; top: 2px; position: absolute; width: 40px; right: 724px;" ForeColor="#FFCC00" meta:resourcekey="ehitsResource1" ViewStateMode="Enabled"></asp:TextBox>
        ...
        <asp:TextBox ID="treasure" runat="server" AutoPostBack="False" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" ReadOnly="True" Style="z-index: 1; left: 823px; top: 33px; position: absolute; width: 54px; height: 15px;" ForeColor="#FFCC00" meta:resourcekey="treasureResource1" ViewStateMode="Enabled"></asp:TextBox>
 <asp:Label ID="Label3" runat="server" ForeColor="#FFCC00" style="z-index: 1; left: 563px; top: 334px; position: absolute" Text="Loading ......." ClientIDMode="Static"></asp:Label>
    ...
    <audio id="sound1" src='<%=ctrl1mainsound%>' autoplay="autoplay">
            ...
            <a href="https://twitter.com/share">s</a>
    ...
    <label style="position: absolute; top: 31px; left: 721px; height: 19px; color: #FFCC00; font-family: 'Jokerman LET'; font-size: large;">Treasure($)</label>
...
<asp:TextBox ID="TextBox1" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" Style="z-index: 1; left: 773px; top: 9px; position: absolute; width: 143px; " ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false" Font-Names="OldDreadfulNo7 BT" Font-Size="Medium">Time Remaining</asp:TextBox>
<asp:TextBox ID="TextBox2" runat="server" BackColor="Transparent" BorderStyle="None" ClientIDMode="Static" Style="z-index: 1; left: 929px; top: 14px; position: absolute; width: 34px" ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false">120</asp:TextBox>
