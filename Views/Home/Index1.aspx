...
function (response) {
    ...
    <form id="form1" runat="server">
        <div style="width: 438px; height: 300px; z-index: 1000; left: 359px; top: 147px; visibility: hidden; position: absolute; background-color: #669999;" id="showwinner">
            <img id="Img9" src="https://treasurehunter.apphb.com/Images/goldshower.gif" style="border: thin solid Transparent; width: 418px; height: 200px; top: 5px; left: 10px; z-index: 1011; right: 6px; bottom: 91px; position: absolute;" />
            ...
            <asp:Label ID="Label22" runat="server" Style="z-index: 1001; left: 18px; top: 260px; position: absolute; vertical-align: middle; text-align: center; width: 200px; margin-top: 0px;" Text="Congratulations You Have conquered this TreasureSpot. Keep Playing." ForeColor="White" Font-Bold="True"></asp:Label>
        </div>
