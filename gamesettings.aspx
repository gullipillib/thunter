...
<body style="background-color: #FF00FF">
    ...
    <asp:Panel ID="Panel1" runat="server" style="z-index: 1; left: 16px; top: 5px; position: absolute; height: 1098px; width: 894px">
       ...
       <asp:Button ID="Button4" runat="server" Style="z-index: 1; left: 627px; top: 316px; position: absolute; border-radius: 15px;" Text="Bid" UseSubmitBehavior="False" BackColor="#FF9900" ForeColor="White" />
        ...
        <asp:HyperLink ID="Hyperlink3" runat="server" Font-Underline="False" NavigateUrl="~/approver.aspx" Style="z-index: 1; left: 375px; top: 11px; position: absolute; border-radius: 15px" Target="_self" Font-Names="Arial" BackColor="#00FF99" ForeColor="#0000CC">Treasure Spot Approving($0.25)</asp:HyperLink>
...
<a href="https://treasurehunter.apphb.com/Home/Index1" target="_self" style="position:absolute;left:822px; top:47px; width:146px; text-decoration:none; background-color: #0000FF; color: #FFFFFF;  border-radius:20px; right: 233px; text-align: center; font-family: 'Victorian LET';z-index: 1; height: 18px;" > Go On a TreasureHunt </a>
</body>
</html>
